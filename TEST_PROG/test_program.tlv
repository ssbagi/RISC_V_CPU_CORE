...
\m5
   ...
   m5_define(['M5_NUM_INSTRS'],32)
   m5_define(['`define READONLY_MEM(ADDR, DATA) logic [31:0] instrs [0:M5_NUM_INSTRS-1]; assign DATA = instrs[ADDR[$clog2($size(instrs)) + 1 : 2]]; assign instrs = '{m5_instr0['']m5_forloop(['m5_instr_ind'], 1, M5_NUM_INSTRS, [', m5_echo(['m5_instr']m5_instr_ind)'])};'])
...
\TLV
   ...
   // For testing as of now hard coded to select branch instructio
